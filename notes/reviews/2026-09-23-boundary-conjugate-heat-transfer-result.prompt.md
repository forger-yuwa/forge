...
Phase 2 (ソルバ内 fem2d 連成) の §4.6a 設計・§5.1 #66-#72 の実測・§6 V4b の合否に集中する。特に (1) 流束の 42 更新移動平均が固定点や遅れの点で妥当か、(2) D_f を分解と一緒に凍結する実装が正しいか、(3) G-if が壁温の単調ドリフト中でも通り得ることの扱い、(4) Mark II を報告項目にした判断
