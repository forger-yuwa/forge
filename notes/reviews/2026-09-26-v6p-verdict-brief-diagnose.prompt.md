...
## ブリーフ (`notes/sessions/2026-09-26-v6p-verdict-brief.md`)
...
**V6′ の登録の修正 (2026-09-26。**float32 の報告 run `run_0009_v6p_prod` を見てから直した** — 隠さず書く。`diagnostician` に諮った)**
...
## 参考: `case/58.conjugate_slot/README.md`
...
**次**: 帯の閾値を 1/4 に締め ($Pe\le$2.5e-3 / 線形残差 ≤2.5e-4 / 勾配比 ≤2.5e-3)、連成の保存性の検査
((e) 伝達差 ≤0.1 % / (f) $T$ 連続 ≤1e-3 K) を加えたうえで、**全域 FP64 ビルドで同設定 1 run** を回して
V6′ の合否を確定する。事前予測は (a) ≤0.3 / (b) ≤0.1 / (c) ≤0.3 / (d) ≤0.3 %、帯 ≥15W。
```
