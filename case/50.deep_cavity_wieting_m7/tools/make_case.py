#!/usr/bin/env python3
"""case/50 の run 生成 — 燃焼生成物 TP (5 種) + 層流 + 段階起動。
...
BC = """inlet:  {{physID: 1, kind: inlet_uniformVelocity, outputHDFflg: 0, ints: , floats: {{ro: {ro:.8e}, Ux: {u:.6f}, Uy: 0.0, Uz: 0.0, Ps: {p:.6f}{ys}}}}}
