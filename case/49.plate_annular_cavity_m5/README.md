...
| `run_0401_s2_off000_tw20` → `_ext1` → `_ext2` → **`_ext3`** | 形状2 (φ50/深さ25/すきま3mm) 同心・壁温 20 ℃・M9・TP。ゲート未達で本段のみ 3 回自動延長 | **`_ext3` が正本**。h_eff 外筒 153.5 / 円柱 119.9 / 底 82.3 W/m²K、Q 211.8 W (全周)。`GATES: PASS` (caveat 壁解像 y1+>1 が 32.5 %) | active (`_ext3` 正本 / 他は経過) |
