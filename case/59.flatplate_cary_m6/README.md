...
| `run_0005_tw02_re027_fine` | **壁解像を満たすメッシュ** `fp_y1_0.35um_nx2800` (y1 0.35 µm、平板 2800 セル、39.7 万セル、AR 最大 1017 `SOFT-PASS`)。run_0004 の res_20000 から `interp_field.py` (別メッシュ)、本段設定のみ、**全域 FP64** (`~/forge56-double`)、30,000 step、出力 5000 毎 (AWS 空き 2.7 GB) | 実行中 (step 5,234 で NaN 0) | active |
