...
| `run_0112_va_cpg_fine_ad_plain` / `run_0113_va_cpg_fine_iso300_plain` / `su2_va_cpg_ad` / `su2_va_cpg_iso300` | **S3 SU2 クロスチェック対** (plan §4.4): CPG (`cfd_gas: cpg`, γ 1.32752) + 素 SST、同一メッシュ (msh→su2)、SU2 は forge 場から warm start | (待機) | active |
