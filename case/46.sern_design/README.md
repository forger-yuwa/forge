...
| `run_0412_3d_wallres` (AWS) | **R5d: 壁解像 y⁺≈1 メッシュ** (`problem_3d_sst_cycle_m6on_wallres.yaml`: `first_wall_frac` 4.8e-05 / `first_z_frac` 4.4e-05 / `first_top_frac` 1.7e-04 / `first_wake_frac` 2.2e-04、層数 +21〜+34。plan sern-3d §4.26.1/§4.30) | 生成 **成功** (5,511,173 節点 / 5,638,114 要素、`sern.msh` 649 MB)。初回は `convertGmshToForge` が **OOM kill** (RSS 8.6 GB / ホスト 15 GB、他 2 計算と同居)。**単独で再変換中** | active |
