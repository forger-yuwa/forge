...
| `run_0112_cmc_tc1045` … `run_0116_cmc_tc1075` (AWS) | **T_c 応答曲線** (couple 7, ξ 整合修正後): run_0111 の状態から T_c = 1045/1030/1060/1015/1075 K で各 3000 step (30 ms) dual-time, 他ジョブが無いときだけ直列投入 (`run_tc_sweep_polite.sh`, ログ `tc_sweep_aws_2026-09-12c.log`) | (実行中) | active |
