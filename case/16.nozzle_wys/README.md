...
| `run_0415_perf_rcm_baseline` (AWS) | 2.37M ext メッシュを `mesh.renumber: rcm` で再変換 (`/MESH/RENUMBER_PERM`)、run_0234/res_12000 を `permute_res_h5.py` で移植。RCM・dq パック・原始量パックの A10G A/B | (キュー中) | active (A/B 用) |
