...
| `run_0414_cfl8_sweep4` (AWS) | run_0413 と同 IC・config で `cfl_pseudo` 6→8 (nStepInner 4, thermoFloat 既定 1) の壁時計 vs 残差比較 (plan §5.1 #8) | (投入 2026-09-12, 結果は plan §5.1 #8) | active |
