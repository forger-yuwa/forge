...
- **凝縮 ON の経路** (相変化ソース・二相 EOS・面潜熱) は 2026-09-13 時点で double のまま残っており、凝縮 ON で 89.5 ms/step (dry 33.8)。float 化は [plans/active/condensation-float-speedup.md](../../plans/active/condensation-float-speedup.md) (設計は [condensation.md](../condensation.md) 実装 §9)。
