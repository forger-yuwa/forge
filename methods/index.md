...
- [`architecture/performance.md`](architecture/performance.md) — 性能プロファイル (カーネル別 ms/step)・計測手順 (bench_steps/nsys/ncu/cuobjdump)・数値精度 (float32 既定, リテラル接尾辞, double の限定) の方針
