...
表の再現誤差は 374–600 K で 5.8e−8、600–640 K で 5.4e−8、640–647.2 K で 7.1e−6、647.2 K 以上で 3.7e−8 と
既存の表試験の許容 1e−4 を全域で満たす。

$T>T_c$ に $g>0$ が残る状態 (強制全蒸発にするか反転失敗として弾くか) は未決で、`condensation-followups.md` に残す。
