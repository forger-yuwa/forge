...
| [turbulence-sst-consistency-options.md](active/turbulence-sst-consistency-options.md) | `turbulence` | codex 副次指摘の SST 整合オプション 5 件 (node 壁 k ピン既定 ON / P_ω from P_k / σ F1 ブレンド / 等方応力 / E–k 源) + 相似メッシュ試験ツール。A/B 検証中 (2026-09-08) |
