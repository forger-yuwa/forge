...
| [turbulence-sst-node-corner-heating.md](active/turbulence-sst-node-corner-heating.md) | `turbulence / boundary (node)` | node × SST の側壁∩輪郭壁の角線で ω が壁漸近解の 1/30 に落ち、k 未減衰→角部が Tt 超え加熱 (case/16 3D, 2026-09-08)。打ち手 R1 (ω 底層床) / R2 (拡散離散化追跡) を codex レビュー中 |
