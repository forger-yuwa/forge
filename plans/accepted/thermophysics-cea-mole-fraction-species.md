...
| 8 | F-sp1: トレーサ `roXi` の拡散 (SST の SERN で必要なら混合平均 Sc) | → plan [species-passive-scalar-unification](../active/species-passive-scalar-unification.md) (2026-09-17): トレーサを化学種カーネルの受動種にして 2 次 + Fick/乱流拡散 (粘性二流体試験もそこで) |
