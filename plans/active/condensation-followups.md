...
| ~~F-cf5~~ | ~~H2O の潜熱が 373.15 K 超で増加する~~ **決着 (2026-09-14)**: `plans/active/condensation-h2o-latent-supercritical.md` で Watson 型外挿 (指数 0.38、646.15 K で凍結) に差し替え。IAPWS 飽和線と 400–623 K で rms 1.4 %。codex plan/result レビュー済み | 完了 |
