...
| ~~F-cf9~~ | ~~蒸気 c_p,v の出どころ~~ **独立 plan へ分離 (2026-09-14, codex result M3)**: [`condensation-vapour-cp-source.md`](condensation-vapour-cp-source.md)。CPG は `physProp.cp`、TP は種固有内蔵値。Kantrowitz の γ_v 用 cp/cv とは分離。空気キャリアで onset 不変・液滴モーメント 2.4–2.9 % 変化。CPG carrier EOS の液相顕熱は同 plan §5.1 #1 へ | 分離 |
