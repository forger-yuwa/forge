...
| **(e) 段階起動: 弱い壁 (0) で再循環を立ててから Dirichlet (1) に戻す** | 後端面に向かう流れができれば固定 CV も満たされる | 試験中 (`run_0429_3d_junction_diag_wd_after_nowd`: run_0428 の res_1800 から 1 で 1800 step) | 弱い壁の段で入口角が抜ける (上) ので、その段は短くする必要 |
