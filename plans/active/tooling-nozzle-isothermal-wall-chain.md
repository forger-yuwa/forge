...
| 9 | **AR 緩和の A/B** (§8-3 決着): `problem_va_R2_LU6_Lc8_ns_ar5k{,_iso300}.yaml` (ni 2401 / nj 121 / wff 8e-6 / wfft 8e-7, AR max 4140, スロート y₁⁺_cold ≈ 1.0, 290k 節点) で run_0116 (断熱, 同壁, IC run_0108) → run_0117 (300 K 同壁) → run_0118 (pass 0)。判定: run_0108/0114 との差 (出口 M ≤0.1 %, ṁ ≤0.1 %, δ_r ≤5 %, Q_w ≤10 %) と発散/残差床の有無 | `run_iso_chain_ar5k.py` (2026-09-12 投入) |
...
- `2026-09-12` — **AR 上限を壁法線構造層で ≤5000 に緩和 (ユーザ決定)**。AGENTS.md・手順書・runner (`mesh.ar_max`) に反映、A/B (§5.1-9) 投入。
